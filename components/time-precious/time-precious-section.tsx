...
const TimePreciousSection = () => {
  return (
    <section className="bg-[#FDF8F2] border-b border-[#E1D2BF]">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-16 sm:px-10 md:grid-cols-2 md:gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(260px,320px)_minmax(0,1fr)] lg:py-11.25 xl:max-w-[1810px] 2xl:grid-cols-[minmax(0,1fr)_360px_minmax(0,1fr)] 3xl:grid-cols-[minmax(0,1fr)_400px_minmax(0,1fr)] 2xl:gap-12 2xl:px-16">
